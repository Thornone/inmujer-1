<?php
# http://livedemo00.template-help.com/wt_52736/
          ...
          <div class="row">
            ...
            <div class="grid_6">
              <div class="phone wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s">
                ...
                <div class="header_tel">01-800-Hablalo</div>
                <div class="header_tel">075-UNEVIG</div>
                <div class="header_tel">867-713-52-81</div>
              </div>
            </div>
          </div>
  ...
  <div id="stuck_container">
    <div class="container">
      <div class="row">
        ...
        <div class="grid_3">
          <div class="socials">
            <ul class="socials1" style="margin-top:10px;text-align:right;">
              ...
              <li class="wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s"><a href="#"><i class="fa fa-youtube"></i></a></li>
            </ul>
          </div>
        </div>
      </div>
